    ...
    <>
      ...
      <Rows
        rows={[
          ...
          ["preload?: string", "Path to a preload script, the same as Electron's webPreferences.preload."],
          ["partition?: string", "Storage partition for cookies and local storage, the same as Electron's. Persistent unless it already starts with persist:."],
          ...
          ["onOpenWindow?(details)", "What window.open and target=_blank links do. Return \"popup\" (the default: a popup drawn over the view), \"deny\", or \"navigate\" to load the URL in this view."],
